...
export interface GetTopicQueryArgs {
  topicId: number;
}
...
export interface GetMyTopicsResponse {
  ok: boolean;
  error: string | null;
...
export interface Mutation {
  ...
  AddTopic: AddTopicResponse;
  DeleteTopic: DeleteTopicResponse;
  EditTopic: EditTopicResponse;
  CompleteEmailVerification: CompleteEmailVerificationResponse;
  CompletePhoneVerification: CompletePhoneVerificationResponse;
  EmailSignIn: EmailSignInResponse;
  EmailSignUp: EmailSignUpRespose;
...
export interface AddTopicMutationArgs {
  subject: string;
  content: string;
  isFav: boolean;
}

export interface DeleteTopicMutationArgs {
  topicId: number;
}

export interface EditTopicMutationArgs {
  topicId: number;
  subject: string | null;
  content: string | null;
  isFav: boolean | null;
...
export interface EditTopicResponse {
  ok: boolean;
  error: string | null;
}
...
export interface EmailSignUpRespose {
  ok: boolean;
  error: string | null;
  token: string | null;
}
